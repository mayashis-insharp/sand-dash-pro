            ...
            <tbody>
              {drafts.map(d => (
                <tr key={d.no} className="border-b border-border/60 last:border-0 hover:bg-muted/30">
                  ...
                  <td className="px-4 py-4"><Button size="icon" variant="ghost" aria-label="Edit" title="Edit" onClick={() => setEditEmp(d)} className="h-7 w-7"><Edit className="h-3.5 w-3.5" /></Button></td>
                </tr>
              ))}
            </tbody>
          </table>
